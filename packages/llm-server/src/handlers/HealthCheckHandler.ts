...
import { Question, ScaleQuestion, BooleanQuestion, TextQuestion, ValidatedAnswer } from './questions/index.js';
...
export class HealthCheckHandler {
    ...
    static parseHealthCheckAnswers(questions: Question[], answers: string[]): ParsedHealthCheckData {
        ...
        for (let i = 0; i < questions.length; i++) {
            ...
            const questionText = question.getQuestion();
