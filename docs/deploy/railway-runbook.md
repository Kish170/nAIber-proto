...
DEMO_CAREGIVER_EMAIL=<email you set in DEMO_CAREGIVER_EMAIL when seeding>
DEMO_CAREGIVER_PASSWORD_HASH=<bcrypt hash — generate with: npx tsx scripts/hash-demo-password.ts yourPassword>
